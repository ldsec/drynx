...
./drynx server setupNonInteractive --serverBinding "10.90.39.16:2000" --description "Drynx Server 1" \
        --privateTomlPath "test/srv1-private.toml" --publicTomlPath "test/srv1-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.18:2000" --description "Drynx Server 2" \
        --privateTomlPath "test/srv2-private.toml" --publicTomlPath "test/srv2-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.19:2000" --description "Drynx Server 3" \
...
./drynx server setupNonInteractive --serverBinding "10.90.39.16:2100" --description "Drynx DP 1" \
        --privateTomlPath "test/dp1-private.toml" --publicTomlPath "test/dp1-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.16:2200" --description "Drynx DP 2" \
        --privateTomlPath "test/dp2-private.toml" --publicTomlPath "test/dp2-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.16:2300" --description "Drynx DP 3" \
        --privateTomlPath "test/dp3-private.toml" --publicTomlPath "test/dp3-public.toml"

./drynx server setupNonInteractive --serverBinding "10.90.39.18:2100" --description "Drynx DP 4" \
        --privateTomlPath "test/dp4-private.toml" --publicTomlPath "test/dp4-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.18:2200" --description "Drynx DP 5" \
        --privateTomlPath "test/dp5-private.toml" --publicTomlPath "test/dp5-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.18:2300" --description "Drynx DP 6" \
        --privateTomlPath "test/dp6-private.toml" --publicTomlPath "test/dp6-public.toml"

./drynx server setupNonInteractive --serverBinding "10.90.39.19:2100" --description "Drynx DP 7" \
        --privateTomlPath "test/dp7-private.toml" --publicTomlPath "test/dp7-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.19:2200" --description "Drynx DP 8" \
        --privateTomlPath "test/dp8-private.toml" --publicTomlPath "test/dp8-public.toml"
./drynx server setupNonInteractive --serverBinding "10.90.39.19:2300" --description "Drynx DP 9" \
