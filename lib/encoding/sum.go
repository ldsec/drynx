...
func EncodeSumWithProofs(input []int64, pubKey kyber.Point, sigs []lib.PublishSignature, l int64, u int64) (*libunlynx.CipherText, []int64, []lib.CreateProof) {
	...
	sumEncrypted, r := lib.EncryptIntGetR(pubKey, sum)

	if sigs == nil {
		return sumEncrypted, []int64{sum}, nil
	}
	//input range validation proof
	cp := lib.CreateProof{Sigs: sigs, U: u, L: l, Secret: sum, R: r, CaPub: pubKey, Cipher: *sumEncrypted}

	return sumEncrypted, []int64{sum}, []lib.CreateProof{cp}
}
