...
func TestServiceDrynxLogisticRegressionBC(t *testing.T) {
	...
	//*
	BCinitweights := []float64{0.921455, -0.377080, -0.313317, 0.796285, 0.992807,
		-0.650099, 0.865773, 0.484040, 0.021763, 0.809766,
		0.222401, 0.309993, 0.375320, 0.674654, -0.961690,
		-0.950472, -0.753475, -0.353844, 0.717381, -0.319103,
		-0.664294, -0.573008, -0.401116, 0.216010, -0.810675,
		0.961971, -0.412459, -0.507446, 0.585540, -0.273261,
		0.899775, -0.611130, -0.223748, 0.008219, -0.758307,
		0.907636, -0.547704, -0.464145, 0.677729, 0.426712,
		-0.862759, 0.090766, -0.421597, -0.429986, 0.410418,
		-0.664294, -0.573008, -0.401116, 0.216010, -0.810675,
		0.961971, -0.412459, -0.507446, 0.585540, -0.273261,
		-0.664294, -0.573008, -0.401116, 0.216010, -0.810675,
		...
		-0.664294, -0.573008, -0.401116, 0.216010, -0.810675,
		-0.664294, -0.573008, -0.401116, 0.216010, -0.810675,
		-0.664294, -0.573008, -0.401116, 0.216010, -0.810675, 1}
	fmt.Println("len of BCinitweights:", len(BCinitweights))
	dataset := "BC"
	lrParameters := libdrynx.LogisticRegressionParameters{K: 2, PrecisionApproxCoefficients: scale, Lambda: 1.0,
		Step: 0.1, MaxIterations: 200, InitialWeights: BCinitweights}
...
func TestServiceDrynxLogisticRegressionGSE(t *testing.T) {
	...
	//*
	GSEinitweights := []float64{0.921455, -0.377080, -0.313317, 0.796285, 0.992807,
		-0.650099, 0.865773, 0.484040, 0.021763, 0.809766,
		0.222401, 0.309993, 0.375320, 0.674654, -0.961690,
		-0.950472, -0.753475, -0.353844, 0.717381, -0.319103,
		-0.664294, -0.573008, -0.401116, 0.216010, -0.810675,
	...
	dataset := "GSE"
	lrParameters := libdrynx.LogisticRegressionParameters{K: 2, PrecisionApproxCoefficients: scale, Lambda: 1.0,
		Step: 0.1, MaxIterations: 200, InitialWeights: GSEinitweights}
